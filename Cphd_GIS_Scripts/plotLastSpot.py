#Plot Locational Data to make a map for the LAST SPOT of snakes.
#Ensure the file is called LastSpot and that the sheet is named Coordinates
...
out_gdb = "Locations.gdb"
#Set local variables:
in_table = "LastSpot.xls\Coordinates$"
x_coord = "Long"
y_coord = "Lat"
