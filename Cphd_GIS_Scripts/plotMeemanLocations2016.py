#Plot Spatial Data to make a map for the locations of Meeman snakes.
#Ensure the file is called Meeman and that the sheet is named Coordinates
...
#Set local variables:
in_table = "Meeman2016.xls\Coordinates$"
x_coord = "Long"
y_coord = "Lat"
...
in_fc = out_fc
out_fc2 = "Meeman_Locations2016_"+date
