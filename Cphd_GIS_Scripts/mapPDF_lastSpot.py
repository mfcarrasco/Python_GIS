...
locationsFC = r"C:\GIS_Work\Cphd_Locations\Locations.gdb\Last_Spot"
locationsLyr = arcpy.MakeFeatureLayer_management(locationsFC, "Last_Spot") #Should add the layer to the map (and then must be saved if wanted for later)
print "Created a temporary layer using Overton Locations"

#Save the layer
arcpy.SaveToLayerFile_management(locationsLyr, "Last_Spot.lyr")
print "Saved the overton park layer file"

#Add layer to map
df = arcpy.mapping.ListDataFrames(mxd, "Layers")[0]
addLayer = arcpy.mapping.Layer(r"C:\GIS_Work\Cphd_Locations\Last_Spot.lyr")
...
arcpy.Delete_management(r"C:\GIS_Work\Cphd_Locations\Last_Spot.lyr")
print "Deleted Last Spot Layer file"
